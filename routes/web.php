...
Route::get('/form-admin', [HomeController::class, 'tentang']);
...
Route::get('/input-admin', [HomeController::class, 'input_admin']);
...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/log-history', [DashboardController::class, 'log_history']);

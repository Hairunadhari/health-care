...
<main class="flex-grow flex flex-col justify-center px-8 md:px-20 lg:px-32">
        <div class="max-w-4xl">
            ...
            <div class="mt-8">
                <button class="group flex items-center border-2 border-white px-6 py-2 gap-3 hover:bg-white hover:text-blue-900 transition-all duration-300 font-bold text-xl uppercase">
    ...
    <footer class="p-8 md:px-20 lg:px-32 text-center md:text-left">
        <p class="text-sm md:text-base font-light max-w-5xl leading-snug">
            Website kesehatan bekerja sebagai platform digital yang mudah diakses melalui browser, tanpa perlu instalasi aplikasi. 
            Semua fitur pengingat, edukasi, dan pemantauan dapat digunakan kapan saja secara online.
        </p>
    </footer>

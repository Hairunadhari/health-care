...
<body class="bg-medical min-h-screen flex items-center justify-center overflow-hidden font-sans">
    ...
    <div class="w-full h-screen flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-3/5 flex flex-col justify-center px-12 lg:px-24 relative">
            <div class="flex items-center gap-3 mb-6 text-white">
                ...
                <h1 class="text-5xl font-extrabold tracking-tight">Registrasi</h1>
            </div>

            <form action="/register-submit" method="POST" class="space-y-5 max-w-md" enctype="multipart/form-data">
                @csrf
                <div>
                    <div class="relative">
                        <input required type="text" name="name" value="{{ old('name') }}" placeholder="Nama Lengkap..." class="w-full bg-gray-300/60 placeholder-black text-black py-4 px-6 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-400
    ...
    <div>
        <div class="relative">
            <input required type="email" name="email" value="{{ old('email') }}" placeholder="Email..." class="w-full bg-gray-300/60 placeholder-black text-black py-4 px-6 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-400
    ...
    <div>
        <div class="relative">
            <input required type="password" name="password" placeholder="Password..." class="w-full bg-gray-300/60 placeholder-black text-black py-4 px-6 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-400
    ...
    <div class="hidden md:flex w-2/5 right-curve flex-col justify-center items-center text-white text-center p-10">
        ...
        <a href="/login" class="group flex items-center gap-3 text-2xl font-bold hover:scale-110 transition-transform">

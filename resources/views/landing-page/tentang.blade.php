...
<div class="relative min-h-screen overflow-hidden" x-data="{ 
    ...
    <div class="slider-container h-screen relative">
        ...
        <div x-show="slide === 1" x-transition.opacity.duration.1000ms class="absolute inset-0 w-full bg-white">
            <main class="container mx-auto mt-12 px-4 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                <div class="relative">
                    ...
                    <div class="absolute bottom-10 -left-4 md:-left-8 bg-custom-blue p-6 text-white max-w-xs shadow-2xl">
                        <p class="italic text-center text-lg leading-tight font-medium">"Permasalahan kepatuhan pasien membutuhkan pendekatan yang lebih modern."</p>
                    </div>
                </div>
                <div class="pt-8">
        ...
        <div x-show="slide === 2" x-transition.opacity.duration.1000ms class="absolute inset-0 w-full bg-white" style="display: none;">
            <section class="grid grid-cols-1 md:grid-cols-2 min-h-full">
                <div class="p-8 md:p-20 flex flex-col justify-between">
                    <div>
                        <h1 class="text-5xl font-extrabold text-slate-900 mb-10"><span class="bg-orange-400 px-2 py-1">Problems</span> We Found</h1>
                    ...
                    <div class="mt-8 overflow-hidden">
                        <img src="{{ asset('assets-landingpage/img/tentang-kanan.jpeg') }}" class="w-full h-65 object-cover">
                    </div>
                </div>
                <div class="flex flex-col">
                    <img src="{{ asset('assets-landingpage/img/tentang-kiri.jpeg') }}" class="h-1/2 w-full object-cover">
        ...
        <div x-show="slide === 3" x-transition.opacity.duration.1000ms class="absolute inset-0 w-full bg-white" style="display: none;">
            <section class="container mx-auto py-12 px-6 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="flex flex-col space-y-8">
                    <h1 class="text-5xl font-extrabold text-black">Our Digital <span class="relative inline-block">Solution<span class="absolute top-1/2 left-0 w-full h-4 bg-orange-400 -z-10 opacity-90"></span></span></h1>
                    <div class="flex gap-4 items-start">
                        <div class="shrink-0 w-16 h-16 border-2 border-purple-500 flex items-center justify-center"><i class="fas fa-pills text-blue-500 text-3xl"></i></div>
                        <p class="text-lg text-gray-800 font-medium">Website digital pengingat minum OAT dengan fitur notifikasi, edukasi, pencatatan kepatuhan harian, dan dashboard tenaga kesehatan.</p>
                    </div>
                    <div class="space-y-4">
                        <h3 class="font-bold text-xl">Meningkatkan kepatuhan terapi</h3>
                        <p>Aplikasi membantu pasien untuk tidak lupa minum obat melalui pengingat otomatis, pencatatan harian, dan tampilan jadwal yang jelas sehingga pasien lebih konsisten menjalani pengobatan.</p>
                        <h3 class="font-bold text-xl">Mempermudah pemantauan</h3>
                        <p>Tenaga kesehatan dapat melihat status kepatuhan pasien secara cepat dan akurat, sehingga intervensi dapat dilakukan lebih awal ketika ada ketidaksesuaian jadwal minum obat.</p>
                        <h3 class="font-bold text-xl">Mendukung eliminasi TB 2030</h3>
                        <p>Dengan meningkatkan kepatuhan dan memperkuat pemantauan, aplikasi ini membantu mengurangi angka putus obat dan risiko resistensi, sehingga turut berkontribusi pada program nasional eliminasi Tuberkulosis tahun 2030.</p>
                    </div>
                </div>
            </section>
        </div>

        <div x-show="slide === 4" x-transition.opacity.duration.1000ms class="absolute inset-0 w-full bg-white" style="display: none;">
            <section class="grid grid-cols-1 md:grid-cols-3 gap-8 min-h-full">
                <div class="p-8 md:p-12 space-y-8">
                    <h1 class="text-5xl font-extrabold text-slate-900 flex items-start">
                        ...
                        <span>Main <span class="relative">Features<span class="absolute bottom-2 left-0 w-full h-3 bg-orange-400 -z-10"></span></span></span>
                    </h1>
                    <p>Fitur utama yang dirancang untuk mendukung pasien TB Paru dalam menjalani terapi OAT secara lebih mudah dan teratur:</p>
                    <div class="space-y-4">
                ...
                <div class="flex flex-col">
                    <div class="bg-custom-blue p-12 text-white italic text-center flex items-center justify-center min-h-[300px] text-2xl font-bold">
                    ...
                    <div class="p-8 space-y-2 bg-white">
                        ...
                        <p>Sistem keamanan yang melindungi data pasien dengan enkripsi dan autentikasi.</p>
    ...
    <div class="fixed bottom-6 left-1/2 -translate-x-1/2 flex gap-2 z-50">
        <template x-for="i in 4">
            <button @click="slide = i; resetSlider()" 
                class="w-3 h-3 rounded-full transition-all"
                :class="slide === i ? 'bg-orange-500 w-8' : 'bg-slate-400'"></button>
        </template>
    </div>
